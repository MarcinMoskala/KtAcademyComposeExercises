...
import kt.academy.util.ArrowDownIcon
...
private val faq = mapOf(
    "Example question 1" to loremIpsum(100),
    "Example question 2" to loremIpsum(100),
    "Example question 3" to loremIpsum(100),
    "Example question 4" to loremIpsum(100),
)